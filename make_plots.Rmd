...
```{r uf-equiv-abt, fig.width = 6, fig.height = 3}
...
```{r branch-decomp-accum-plot-old, fig.width = 5.5, fig.height = 2.5}
...
```{r branch-decomp-accum-plot, fig.width = 5.5, fig.height = 2.5}
...
```{r branch-decomp-avg-pairs-plot-abt, fig.width = 5, fig.height = 3}
...
```{r unnormalized-branch-decomp-calcs}
...
```{r unnormalized-branch-decomp-accum-plot, fig.width = 5.5, fig.height = 2.5}
...
```{r combined-glomming-abt, fig.width = 4.5, fig.height = 4.5}
library(gridExtra)
...
```{r distatis-abt-plots, fig.height=5.5, fig.width=5.5}
